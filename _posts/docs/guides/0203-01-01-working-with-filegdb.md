...
<pre>{{page.code1}}</pre>
California Albers is also commonly used as [EPSG:3310](http://epsg.io/3310) - here via [EPSG.io](http://epsg.io/), an alternative resource for referencing Proj4 representations.
