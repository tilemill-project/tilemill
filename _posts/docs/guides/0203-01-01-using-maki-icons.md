...
1. [Download the Maki icon set](http://mapbox.com/maki/maki-icon-source/maki.zip), unzip it, and place the Maki folder in your TileMill project directory. You will need to reference the individual icon files later using CartoCSS.
