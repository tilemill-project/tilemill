...
When working with the colorizer it is important to input `band=1` in the **Advanced** input area of the TileMill Add Layer window. If you omit this step, the colorizer will not function properly.
