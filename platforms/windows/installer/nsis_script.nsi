...
Section "MainSection" SEC01
  ...
  ;; Base Installation
  File /r /x *Recycle.Bin* /x Makefil* /x test /x *.vcx* /x *.ipch /x ipch /x AppData /x deps /x include /x expresso /x osx /x ubuntu /x virtualbox /x *.idx /x *.pack /x *.sln /x *.sdf ..\..\..\..\tilemill
